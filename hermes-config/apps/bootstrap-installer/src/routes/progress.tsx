...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Aurobo' : 'Setting up Aurobo'
  const description = isUpdate
    ? 'Aurobo is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Aurobo installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
