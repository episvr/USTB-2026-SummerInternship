...
def main():
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig('results/gru_loss.png', dpi=150)
    plt.close()
    print("损失曲线与散点图已保存: results/gru_loss.png")
    ...
    plt.legend()
    plt.grid(True, alpha=0.3)
    plt.savefig('results/gru_series.png', dpi=150)
    plt.close()
    print("预测曲线图已保存: results/gru_series.png")
