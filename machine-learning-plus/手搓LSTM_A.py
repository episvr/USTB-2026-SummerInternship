...
def main():
    ...
    plt.tight_layout()
    plt.savefig('results/lstm_loss.png', dpi=150)
    plt.close()
    print("损失曲线与散点图已保存: results/lstm_loss.png")
    ...
    plt.legend()
    plt.grid(True, alpha=0.3)
    plt.savefig('results/lstm_series.png', dpi=150)
    plt.close()
    print("预测曲线图已保存: results/lstm_series.png")
